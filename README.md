...
<div align="center">
  <a href="screenshots/dyn_desc.mp4">
    <img src="screenshots/thumbnail.jpg" alt="Dynamic Description" width="300" style="display: block; margin: 0 auto;" />
  </a>
  <div style="color: white; font-weight: bold; margin-top: 10px;">Dynamic Description (click to play)</div>
</div>
- Scrollbars
